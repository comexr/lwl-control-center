...
export class TccPaths {
    ...
    static readonly TCCD_EXEC_FILE: string =
        '/opt/lwl-control-center/resources/dist/lwl-control-center/data/service/tccd';
    static readonly TCCD_PYTHON_CAMERACTRL_FILE: string =
        '/opt/lwl-control-center/resources/dist/lwl-control-center/data/camera/cameractrls.py';
    ...
    static readonly V4L2_NAMES_FILE: string = 
        '/opt/lwl-control-center/resources/dist/lwl-control-center/data/camera/v4l2_kernel_names.json';
